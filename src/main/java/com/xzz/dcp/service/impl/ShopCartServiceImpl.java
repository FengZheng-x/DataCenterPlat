...
public class ShopCartServiceImpl implements IShopCartService {
     ...
     */
    @Override
    public void put(Long userId, Long skuId, Integer finalValue) {
        ...
        Integer max = ShopCartConstant.MAX > finalValue ? finalValue : ShopCartConstant.MAX;
     ...
     * @return
     *
     * @step 1. 根据 skuIds 获得 shopCartSkuDTOs（封装购物车中sku数量 -> count）
    ...
    private Map<Object, Object> scan(String key) {
        ...
        try (Cursor<Map.Entry<Object, Object>> cursor = hashOperations.scan(key,
